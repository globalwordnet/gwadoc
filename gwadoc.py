...
rels.similar.dfn.en = """
A relation between two concepts where concept X and concept
Y are closely related in meaning but are not in the same
synset. Similarity is a self-reciprocal link (the two directions of this relation share the same meaning) — Concept-X is similar to Concept-Y, and Concept-Y is similar to Concept-X.
...
Similarity can be understood as weak synonymy, opposed to the full synonymy that all lemmas in a concept must share.
As adjectives are not structured hierarchically (hyponymy/hypernymy) like verbs or nouns, the similarity link helps showing relations between them.
"""
rels.similar.ex.en = ""
rels.similar.exe.en = """
"""
...
rels.agent.df.en = "the semantic role of the animate entity that instigates or causes the happening denoted by the verb in the clause"
rels.agent.dfn.en = """
...
rels.patient.df.en = "the semantic role of an entity that is not the agent but is directly involved in or affected by the happening denoted by the verb in the clause"
rels.patient.dfn.en = """
...
rels.result.df.en = "the semantic role of the noun phrase whose referent exists only by virtue of the activity denoted by the verb in the clause"
rels.result.dfn.en = """
X Role Y: (A/an) X is comes into existence as a result of Y or, (A/an) X is the result of Y or,
(A/an) X is created by Y."""
rels.result.ex.en = ""
rels.result.exe.en = """
...
rels.instrument.df.en = "the semantic role of the entity (usually inanimate) that the agent uses to perform an action or start a process"
...
location where the action or event expressed by concept Y
takes place."""
rels.location.ex.en = ""
...
rels.direction.df.en = "a line leading to a place or point; a line leading to a place or point"
rels.direction.dfn.en = """
X Role Y: A relation between two concepts where concept X is typically
the direction or location of the action or event expressed
by concept Y. It is possible to Y from/to/over/across/through a place (X)"""
...
rels.target_direction.df.en = "the place designated as the end (as of a race or journey); the place designated as the end (as of a race or journey)"
...
rels.source_direction.df.en = "the place where something begins, where it springs into being"
...
Y involved X: A relation between two concepts where concept B is typically
the patient undergoing an action or event expressed by
concept A."""
...
Y involved X: A relation between two concepts where concept B comes into
existence as a result of concept A."""
...
Y involved X: A relation between two concepts where concept B is typically
the instrument necessary for the action or event expressed
by concept A."""
...
rels.involved_location.df.en = "X is typically the location where the action Y takes place"
rels.involved_location.dfn.en = """
Y involved X: A relation between two concepts where concept B is typically
the location where the action or event expressed by concept
A takes place."""
...
rels.involved_direction.df.en = "X is typically the direction/location of the action Y"
...
rels.involved_source_direction.df.en = "X is the place from where the action Y begins"
rels.involved_source_direction.dfn.en = """
Y involved X: A relation between two concepts where concept B is the place
from where the action or event expressed by concept A
begins/starts/happens."""
...
rels.co_role.df.en = "a pair of linked role relations without an explicit event"
rels.co_role.dfn.en = """
A relation between two concepts where concept X undergoes
an action in which concept Y is involved
(bidirectional)."""
rels.co_role.ex.en = ""
rels.co_role.exe.en = """
"""
...
A relation between two concepts where concept Y is the
patient undergoing an action carried out by concept X.
...
A relation between two concepts where concept Y is the
instrument used by concept X in a certain action.
...
A relation between two concepts where concept Y is the
result of an action carried out by concept X.
...
A relation between two concepts where concept Y undergoes an
...
A relation between two concepts where concept Y undergoes an
action for which the instrument expressed by concept X is
used."""
...
A relation between two concepts where concept X is the
result of an action carried out by concept Y."""
...
A relation between two concepts where concept X is the
result of an action for which the instrument expressed by
concept Y is used."""
...
A relation between two concepts where concept X is the
instrument used by concept Y for a certain action."""
...
A relation between two concepts where concept Y is the
result of an action carried out by the instrument expressed
by concept X."""
...
rels.state_of.df.en = "the way something is with respect to its main attributes"
rels.state_of.dfn.en = """
A relation between two concepts where concept Y is qualified
by concept X."""
...
A relation between two concepts where concept X is qualified
by concept Y.
X is qualified by Y."""
...
rels.causes.df.en = "any entity that produces an effect or is responsible for events or results"
rels.causes.dfn.en = """
A relation between two concepts where concept Y comes into
existence as a result of concept X. Entailment is a relation that links two verbs, and it is currently unilateral — Verb-X causes Verb-Y, without a reciprocal or tracing link. Causation presupposes/requires that some Verb-Y will, inevitably, take place during or after Verb-X (e.g. if Verb-X occurs, then Verb-Y will also occur).
...
A relation between two concepts where concept X comes into
existence as a result of concept Y."""
...
rels.meronym.df.en = "a word that names a part of a larger whole; a word that names a part of a larger whole"
rels.meronym.dfn.en = """
A relation between two concepts where concept Y makes up a
part of concept X."""
...
rels.holonym.df.en = "a word that names the whole of which a given word is a part; a word that names the whole of which a given word is a part"
rels.holonym.dfn.en = """
...
A relation between two concepts where concept Y is a
component of concept X. Meronym and Holonym Part is a paired relation that denotes proper parts (separable, in principle), which preserve a belonging relation even if the physical link is broken — Concept-X can be separated into Concept-Y”; and Concept-Y is a part of some Concept-X.
...
A relation between two concepts where concept X is a
component of concept Y. Meronym and Holonym Part is a paired relation that denotes proper parts (separable, in principle), which preserve a belonging relation even if the physical link is broken — Concept-X can be separated into Concept-Y”; and Concept-Y is a part of some Concept-X.
...
A relation between two concepts where concept X is a member/
element of concept Y. Meronym and Holonym Membership is a paired relation that denotes group formation and membership. Is different from hyponym as it does not relates a subkind of a concept. It links groups to members — Concept-Y is composed of many members of Concept-X; and many instances of Concept-X form Concept-Y."""
...
A relation between two concepts where concept X is made of
concept Y. Meronym and Holonym Substance is a paired relation that denotes a higher bound between part and whole. Separating/removing the substance part, will change the whole — Concept-X is made of Concept-Y; and Concept-Y is a substance of Concept-X”."""
...
A relation between two concepts where concept Y is made of
concept X. Meronym and Holonym Substance is a paired relation that denotes a higher bound between part and whole. Separating/removing the substance part, will change the whole — Concept-X is made of Concept-Y; and Concept-Y is a substance of Concept-X”."""
...
rels.eq_synonym.df.en = "two words that can be interchanged in a context are said to be synonymous relative to that context"
rels.eq_synonym.dfn.en = """
A relation between two concepts where X and Y are equivalent
concepts but their nature requires that they remain separate.
...
A relation between two concepts where A is an example of the
type B."""
...
A relation between two concepts where Y is a a scientific
...
A relation between two concepts where X is a a scientific
...
A relation between two concepts where Y is a geographical /
cultural domain of concept X. Domain(Region) and Domain-Term(Region) is a paired relation between terms/concepts of any part-of-speech and a related geographical region."""
...
geographical and cultural regions).  But we have not yet come up with a good name."""
...
rels.attribute.df.en = "an abstraction belonging to or characteristic of an entity"
rels.attribute.dfn.en = """
A relation between nominal and adjectival concepts where the
concept X is an attribute of concept Y. ‘Attributes’ is a self-reciprocal link (the two directions of this relation share the same meaning) — Concept-X attributes to Concept-Y, and Concept-Y attributes to Concept-X.
...
rels.restricts.df.en = "place limits on (extent or access); place limits on (extent or amount or access)"
rels.restricts.dfn.en = """
A relation between an adjectival concept X
(quantifier/determiner) and a nominal (pronominal) concept
Y."""
...
rels.classified_by.df.en = "arrange or order by classes or categories; arrange or order by classes or categories"
...
rels.also.df.en = "a word having a loose or fuzzy semantic relation to another word"
rels.also.dfn.en = """
...
rels.other.dfn.en = """
This is used for semantic relation types not currently supported by the OMW DTD.
The exact relation type can be given with ``dc:type``:
